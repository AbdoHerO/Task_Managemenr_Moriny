...
function calculate_total() {
  ...
  // adjustment = parseFloat(adjustment); // Origine calculate
  adjustment = ( ( total * parseFloat(adjustment) ) / 100 ); // Origine calculate

  // Check if adjustment not empty
  if (!isNaN(adjustment)) {
    total = total + adjustment; // Origine calculate
  }
