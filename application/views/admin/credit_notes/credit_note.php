        ...
        <div class="row">
            ...
            <div class="col-md-12">
                    ...
                    <div class="panel-body">
                                ...
                                <tbody>
                                    <tr class="main">
                                        ...
                                        <td>
                                            ...
                                            ?>
                                            <button type="button" onclick="add_item_to_table('undefined','undefined',<?php echo $new_item; ?>); return false;" class="btn btn-primary pull-right "><i class="fa fa-check"></i></button>
                                        </td>
                                    </tr>
                        ...
                        <div class="col-md-8 col-md-offset-4">
                            <table class="table text-right">
                                <tbody>
                                    <tr id="subtotal">
                                        <td><span class="bold tw-text-neutral-700"><?php echo _l('credit_note_subtotal'); ?>
                                                :</span>
                                        </td>
                                        <td class="subtotal">
                                        </td>
                                    ...
                                    <tr id="discount_area">
                                        <td>
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <span class="bold tw-text-neutral-700"><?php echo _l('credit_note_discount'); ?></span>
                                                </div>
                                                <div class="col-md-5">
                                    ...
                                    <tr>
                                        <td>
                                            <div class="row">
                                                <div class="col-md-7">
                                                    <span class="bold tw-text-neutral-700"><?php echo _l('credit_note_adjustment'); ?></span>
                                                </div>
                                                <div class="col-md-5">
                                                    <div class="input-group" id="discount-total">
                                    ...
                                    <tr>
                                        <td><span class="bold tw-text-neutral-700"><?php echo _l('credit_note_total'); ?>
                                                :</span>
                                        </td>
                                        <td class="total">
                                        </td>
                ...
                <div class="btn-bottom-toolbar btn-t2oolbar-container-out text-right">
                    <button type="button" class="btn-tr btn btn-default mleft10 credit-note-form-submit save-and-send transaction-submit">
